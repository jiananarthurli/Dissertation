...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{Drawing/Moire.pdf}
...
\begin{figure}[h!]
	...
	\caption{Landau levels and Hofstadter spectra. (a) Magnetic flux through the electron orbits in magnetic field is quantized. (b) Landau fan diagram for 2D system. (c) Additional Landau fans emerge under the periodic potential.}
...
\begin{figure}[h!]
	...
	\caption{Lithography of hexagonal superlattice on graphene. (a) The written and control devices. (b) The hexagonal pattern of superlattice, with $V_\mathrm{min} = -5$ V and $V_\mathrm{max} = +5$ V.}
