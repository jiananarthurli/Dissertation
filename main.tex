...
The properties of graphene on LAO/STO is different from SiO$_2$ or hBN substrates due to the unique properties of the LAO/STO substrate. This section will discuss the transport properties of graphene/LAO/STO samples. 
...
\begin{figure}[h!]
	...
	\caption{Graphene resistance as a function of backgate voltage. The resistance shows a maximum when the chemical potential reaches the CNP. The positions of the CNP are different for forward and backward sweeps. Measured at T = 2 K.}
	\label{FIG:DiracPeak}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Carrier density and mobility of graphene measured from Hall effect.}
...
In this section, the experiment of using c-AFM to dope the graphene into $p$-$n$ junction to engineer the edge state mixing is discussed.

\subsection{Quantum Hall edge channels}

\subsection{Graphene doping using c-AFM}



\subsection{Measurement of graphene $p$-$n$ junction}
...
\section{Kerr-rotation optics setup}
