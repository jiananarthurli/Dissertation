...
Graphene and complex-oxide interface are two paradigms of 2D systems that attracted numerous researches for more than a decade. The two dimensional gas (2DEG) in both systems differ in many ways from the properties of the traditional semiconductor materials. This research is dedicated to integrating these two versatile systems and study the interactions between the carrier in graphene and complex-oxide interface. Conventionally, the transfer of graphene grown by chemical vapor deposition is assisted by poly(methyl methacrylate) (PMMA) and is widely used for electronic device fabrication for its flexibility. The downside of the method is that the quality of graphene is limited by the residue left by the polymer. A new transfer method is developed in this research that protect the graphene against contaminations. The graphene transferred onto the complex-oxide heterostructure substrates is atomically clean with with mobility. Conductive atomic force microscope (c-AFM) writing technique is applied to graphene-complex-oxide heterostructure to reversibly control the position of charge-neutrality point (CNP) with nanoscale resolution, utilizing the tunability complex-oxide substrate. The local electron density and conductivity of the complex-oxide heterostructure interface can be patterned with the c-AFM tip, and the CNP of the proximal graphene is shifted. Using this effect, the mixing of edge state in quantum Hall regime on the edge of graphene p-n junctions can be reversibly controlled. Quantization of resistance are observed as a result of the mixing at low temperature, depending on the directions of currents and magnetic fields. Nanoscale devices such as superlattice can be readily produced on two dimensional material heterostructure from this technique.
